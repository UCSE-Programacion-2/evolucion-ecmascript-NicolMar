...
function explicarConcurrenciaYParalelismo() {
  ...
  return {
    concurrencia:
      "La concurrencia permite que varias tareas progresen en periodos superpuestos, intercalando su ejecucion.",
    paralelismo:
      "El paralelismo permite que varias tareas se ejecuten literalmente al mismo tiempo, por ejemplo en distintos nucleos.",
  };
}
